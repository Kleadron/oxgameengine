...
namespace Ox.Scene.EffectNamespace
{
    ...
    public class LightReceiverEffect : FogReceiverEffect
    {
        ...
        /// <summary>
        /// Set a bool array of size SceneConfiguration.DirectionalLightCount that tells if each
        ...
        /// <summary>
        /// Set a Vector3 array of size SceneConfiguration.DirectionalLightCount that tells of each
        ...
        /// <summary>
        /// Set a Color array of size SceneConfiguration.DirectionalLightCount that tells of each
        ...
        /// <summary>
        /// Sets a bool array of size SceneConfiguration.PointLightCount that tells is each point
        ...
        /// <summary>
        /// Set a Vector3 array of size SceneConfiguration.PointLightCount that tells of each point
        /// light's position.
        /// </summary>
        ...
        /// <summary>
        /// Set a float array of size SceneConfiguration.PointLightCount that tells of each point
        /// light's range.
        /// </summary>
        ...
        public void PopulateLighting(BaseSurface surface, List<AmbientLight> ambientLights,
            List<DirectionalLight> directionalLights, List<PointLight> pointLights)
        {
            lock (staticLock)
            {
                OxHelper.ArgumentNullCheck(surface, ambientLights, directionalLights, pointLights);
                ...
                for (int i = 0; i < SceneConfiguration.DirectionalLightCount; ++i)
                {
                    ...
                    else
                    {
                        ...
                        directionalLightEnableds[i] = directionalLight.EnabledWorld;
                ...
                for (int i = 0; i < SceneConfiguration.PointLightCount; ++i)
                {
                    ...
                    else
                    {
                        ...
                        pointLightPositions[i] = pointLight.PositionWorld;
                        pointLightEnableds[i] = pointLight.EnabledWorld;
        ...
        private static bool[] directionalLightEnableds = new bool[SceneConfiguration.DirectionalLightCount];
        private static Vector3[] directionalLightDirections = new Vector3[SceneConfiguration.DirectionalLightCount];
        private static Vector3[] directionalLightDiffuseColors = new Vector3[SceneConfiguration.DirectionalLightCount];
        private static Vector3[] directionalLightSpecularColors = new Vector3[SceneConfiguration.DirectionalLightCount];
        private static bool[] pointLightEnableds = new bool[SceneConfiguration.PointLightCount];
        private static Vector3[] pointLightPositions = new Vector3[SceneConfiguration.PointLightCount];
        private static Vector3[] pointLightDiffuseColors = new Vector3[SceneConfiguration.PointLightCount];
        private static Vector3[] pointLightSpecularColors = new Vector3[SceneConfiguration.PointLightCount];
        private static float[] pointLightRanges = new float[SceneConfiguration.PointLightCount];
        private static float[] pointLightFalloffs = new float[SceneConfiguration.PointLightCount];
        ...
        private int[] _directionalLightEnableds = new int[SceneConfiguration.DirectionalLightCount];
        private Vector3[] _directionalLightDirections = new Vector3[SceneConfiguration.DirectionalLightCount];
        private Vector3[] _directionalLightDiffuseColors = new Vector3[SceneConfiguration.DirectionalLightCount];
        private Vector3[] _directionalLightSpecularColors = new Vector3[SceneConfiguration.DirectionalLightCount];
        private int[] _pointLightEnableds = new int[SceneConfiguration.PointLightCount];
        private Vector3[] _pointLightPositions = new Vector3[SceneConfiguration.PointLightCount];
        private Vector3[] _pointLightDiffuseColors = new Vector3[SceneConfiguration.PointLightCount];
        private Vector3[] _pointLightSpecularColors = new Vector3[SceneConfiguration.PointLightCount];
        private float[] _pointLightRanges = new float[SceneConfiguration.PointLightCount];
        private float[] _pointLightFalloffs = new float[SceneConfiguration.PointLightCount];
    }
}
