...
namespace Ox.Engine.MathNamespace
{
    ...
    public class HeightMap
    {
        ...
        public float GrabHeight(Vector2 position)
        {
            ...
            OxMathHelper.Intersection(ref ray, ref triangle, out intersection);
