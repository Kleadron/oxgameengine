...
namespace Ox.Engine.GeometryNamespace
{
    ...
    public static class SkyboxGeometry
    {
        ...
        /// </summary>
        public static Geometry Create(GraphicsDevice device, VertexFactory vertexFactory, string vertexFormat)
        {
            OxHelper.ArgumentNullCheck(device, vertexFactory);

            IVertices verts = vertexFactory.CreateVertices(vertexFormat, 36);
