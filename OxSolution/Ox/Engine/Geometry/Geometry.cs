...
namespace Ox.Engine.GeometryNamespace
{
    ...
    public class Geometry : Disposable
    {
        ...
        public Geometry(GraphicsDevice device, VertexElement[] vertexElements,
            PrimitiveType primitiveType, VertexBuffer vertexBuffer, int vertexSize, int vertexCount)
        {
            OxHelper.ArgumentNullCheck(device, vertexElements, vertexBuffer);
            this.device = device;
        ...
        public Geometry(GraphicsDevice device, VertexElement[] vertexElements,
            PrimitiveType primitiveType, VertexBuffer vertexBuffer, int vertexSize,
            int vertexCount, IndexBuffer indexBuffer, int indexCount)
            : this(device, vertexElements, primitiveType, vertexBuffer, vertexSize, vertexCount)
        {
            OxHelper.ArgumentNullCheck(device, vertexElements, vertexBuffer, indexBuffer);
        ...
        {
            OxHelper.ArgumentNullCheck(device, vertices);
            this.device = device;
            this.primitiveType = primitiveType;
        ...
        {
            OxHelper.ArgumentNullCheck(device, vertices, indices);
