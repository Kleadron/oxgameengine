...
namespace Ox.Engine.GeometryNamespace
{
    ...
    public static class TerrainPatchGeometry
    {
        ...
        /// <param name="vertexFactory">The vertex factory that creates the patches's vertices.</param>
        /// <param name="vertexFormat">The format of the patch's vertices.</param>
        ...
        public static Geometry Create(GraphicsDevice device, VertexFactory vertexFactory,
            string vertexFormat, HeightMap heightMap, Rectangle portion, Vector3 quadScale,
            Vector2 quadTextureScale)
        {
            OxHelper.ArgumentNullCheck(device, vertexFactory, heightMap);
            ...
            // create vertices
            IVertices verts = vertexFactory.CreateVertices(vertexFormat, portion.Width * portion.Height);
        ...
        {
            OxHelper.ArgumentNullCheck(heightMap);
        ...
        public static HeightMap TextureToHeightMap(
            Texture2D heightMapTexture, Vector3 quadScale, Vector2 gridCenterOffset)
        {
            OxHelper.ArgumentNullCheck(heightMapTexture);
        ...
        {
            OxHelper.ArgumentNullCheck(map);
